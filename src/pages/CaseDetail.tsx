...
import type { Case, Task, DbUser, Property, Unit } from '../lib/types'
...
export default function CaseDetailPage() {
  ...
  const addComment = async () => {
    ...
    if (USE_MOCK) {
      setComments((prev) => [{ id: String(prev.length + 1), case_id: id, author_id: 'dev-user', content: newComment, created_at: new Date().toISOString() }, ...prev])
      setNewComment('')
      return
    }
