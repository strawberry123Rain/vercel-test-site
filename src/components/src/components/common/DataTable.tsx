...
export function DataTableHeaderCell({ children, className, onClick }: DataTableHeaderCellProps) {
  return (
    <th 
      className={cn('text-left p-3 select-none', onClick && 'cursor-pointer', className)}
      onClick={onClick}
      scope="col"
    >
      {children}
